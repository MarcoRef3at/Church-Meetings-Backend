...
/* @desc        **Log user out**
                ...
                3-If Token Found, Validate it and get user's info from it and save it to req.user to use it later in redis
                4-Clear Cookies
...
exports.logout = asyncHandler(async (req, res, next) => {
  ...
  if (!token) return next(new ErrorResponse(`You are already logged out`, 401));
